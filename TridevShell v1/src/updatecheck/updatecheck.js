...
//==============================
const LATEST_VERSION_URL = 'https://tridevhungary.com/downloads/version.json';
...
//==============================
/**
 * Checks the production website header strings to locate a newer shell release version.
 * @returns {Promise<boolean>} Resolves to true if a newer production release is active online.
 */
async function updateCheck() {
    return new Promise((resolve) => {
        const url = `${LATEST_VERSION_URL}?t=${Date.now()}`;
        const options = {
            headers: {
